...
function run()
    ...
    for i, item in pairs(selectedItems) do
        ...
        reaper.SetMediaItemInfo_Value(item, 'D_LENGTH', propSource.length)
        reaper.SetMediaItemTakeInfo_Value(take, 'D_PITCH', propSource.pitch)
        reaper.SetMediaItemTakeInfo_Value(take, 'D_PLAYRATE', propSource.playrate)
        ...
        reaper.SetMediaItemInfo_Value(item, 'D_FADEOUTLEN', propSource.fadeoutlen)
        reaper.SetMediaItemInfo_Value(item, 'D_FADEOUTDIR', propSource.fadeoutdir)
        reaper.SetMediaItemInfo_Value(item, 'D_FADEOUTLEN_AUTO', propSource.fadeoutlenauto)
        reaper.SetMediaItemInfo_Value(item, 'D_FADEOUTSHAPE', propSource.fadeoutshape)
